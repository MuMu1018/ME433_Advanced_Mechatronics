...
int rxValL = 0, rxValR = 0, rxDirL = 0, rxDirR = 0; // a place to store the int that was received
int COM = 0;
int error = 0, pwm = 0;
            ...
            if (appData.isReadComplete == true) {
                ...
                while (appData.readBuffer[ii] != 0) {
                    ...
                    if (appData.readBuffer[ii] == '\n' || appData.readBuffer[ii] == '\r') {
                        ...
                        sscanf(rx,"%d",&COM); // get the int out of the array
...
*/
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            if (gotRx) {
                ...
                if(pwm>0){
                    OC1RS = 600; // velocity, 50%
                    OC4RS = (1200-pwm)/3; // turn left
                }else{
                    OC1RS = (1200-pwm)/3; // turn right
