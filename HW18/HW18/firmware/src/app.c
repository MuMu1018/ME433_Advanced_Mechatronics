            ...
            if (appData.isReadComplete == true) {
                ...
                while (appData.readBuffer[ii] != 0) {
                    ...
                    if (appData.readBuffer[ii] == '\n' || appData.readBuffer[ii] == '\r') {
                        ...
                        sscanf(rx,"%d %d %d %d",&rxValL,&rxValR,&rxDirL,&rxDirR); // get the int out of the array
...
*/
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            if (gotRx) {
                ...
                LATAbits.LATA1 = rxDirL; // direction
                OC1RS = rxValL; // velocity, 50%
                LATBbits.LATB3 = rxDirR; // direction
                OC4RS = rxValR; // velocity, 50%
                len = sprintf(dataOut,"got: %d %d %d %d\r\n",rxValL,rxValR,rxDirL,rxDirR);
                i++;
